...
### 🔹 [Бот с расписанием занятий](https://github.com/Pitonslaver228/schedule-bot)
> Telegram-бот для студентов СПбПУ — показывает расписание и уведомляет об изменениях.  
